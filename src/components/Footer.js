...
//             spacing={8}>
//             <Stack spacing={6}>
//               <Box bg={'red'} h={'100px'} w={'120px'} >
//                 <img style={{width:'100%', objectFit:'contain'}} src='https://i.ibb.co/xDJkFGd/Quick-Bite-2.png' alt='logo' />
//                 {/* <Logo color={useColorModeValue('gray.700', 'white')} /> */}
//               </Box>
//               <Text fontSize={'sm'}>
//                 © 2022 Quick Bite. All rights reserved
//               </Text>
...
export default function Footer() {
  return (
    <Box
      bg={useColorModeValue('gray.50', 'gray.900')}
      color={useColorModeValue('gray.700', 'gray.200')}>
        <Box w={'100px'} h={'100px'} pt={"30px"} ml={["15px", "30px", "15px", "55px", "200px"]}>

        <img style={{width:'100%', backgroundColor:'red'}} src='https://i.ibb.co/xDJkFGd/Quick-Bite-2.png' alt='logo' />
        </Box>
      <Container as={Stack} maxW={'6xl'} py={10}>
      ...
      <Box
        ...
        <Container
          ...
          align={{ md: 'center' }}>
          <Text>© 2022 Quick Bite. All rights reserved</Text>
          <Stack direction={'row'} spacing={6}>
            <SocialButton label={'Twitter'} href={'#'}>
              <FaTwitter />
            </SocialButton>
